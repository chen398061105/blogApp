...
class IndexController extends CommonController
{
    ...
    public function index()
    {
        ...
        //图文列表 带分页效果 站点区域/排行榜区域
        $data = Article::orderBy('art_view','desc')->take(15)->get();
        //最新发布文章
        $news = Article::orderBy('art_time','desc')->take(7)->get();
        //banner
        $banner= Cate::all();

       return view('home.index',compact('hot','data','news','banner'));
    }
